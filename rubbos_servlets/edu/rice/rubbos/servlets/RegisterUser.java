...
public class RegisterUser extends RubbosHttpServlet
{
      ...
      throws IOException, ServletException
  {
    ...
    String 	 nickname, firstname, lastname, email;
    String password = null ;
    
    int access = 0, rating = 0;      
    ...
    {
      sp.printHTML("You must provide a firstname!<br>");
      return;
    }

    if (lastname == null || lastname.equals(""))
    {
      sp.printHTML("<h3>You must provide a lastname!<br></h3>");
      return;
    }

    if (nickname == null || nickname.equals(""))
    {
      sp.printHTML("<h3>You must provide nickname!<br></h3>");
      return;
    }
    ...
    sp.printHTML("nickname " +nickname);
    long end_time = System.nanoTime();
	double difference = (end_time - start_time)/1e6;
	System.out.println("**** 10oct2014 reg user rubbos latency:="+difference);
	   
	DbProcessResult result = dbClient.getRegisterUserResult(sp,  nickname, firstname, lastname, email, password,
			 access, rating,end_time, start_time);
    sp=result.sp;
